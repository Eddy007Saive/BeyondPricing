...
// Mock CampagneSchema pour la démonstration
...
export  function Create() {
  ...
  const messageTemplates = [
    ...
    },
    {
      ...
      content: "Salut {nom} ! Je suis tombé sur ton profil et je pense qu'on pourrait avoir une opportunité intéressante pour toi en tant que {poste}. Tu aurais 15 minutes pour en discuter ?"
    }
  ];
  ...
  // Fonction de validation personnalisée basée sur le schéma
